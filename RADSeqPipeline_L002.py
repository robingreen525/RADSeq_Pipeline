...
a="cat *R1* | /fh/fast/shou_w/bin/Robin/fastx/fastx_barcode_splitter.pl --bcfile barcodes.txt --bol --prefix reads/RJG_ --suffix '_L002_R1.fastq'"
b="cat *R2* | /fh/fast/shou_w/bin/Robin/fastx/fastx_barcode_splitter.pl --bcfile barcodes.txt --bol --prefix reads/RJG_ --suffix '_L002_R2.fastq'"
os.system(a)
os.system(b)
...
for line in ll:
	...
	w='python /fh/fast/shou_w/bin/get_unmatched_to_matched.py RJG_'+line+'_L002_R1.fastq RJG_'+line+'_L002_R2.fastq RJG_unmatched_L002_R1.fastq RJG_unmatched_L002_R2.fastq'
	print(w)
	os.system(w)
	
	
	#concatenate all R1 and R2 files so and remove any intermediate files
	w='cat RJG_'+line+'_L002_R1.fastq RJG_'+line+'_L002_R1_new.fastq > RJG_'+line+'_L002_R1_all.fastq'
	z='cat RJG_'+line+'_L002_R2.fastq RJG_'+line+'_L002_R2_new.fastq > RJG_'+line+'_L002_R2_all.fastq'
	
	rmw='rm RJG_'+line+'_L002_R1.fastq'
	rmx='rm RJG_'+line+'_L002_R1_new.fastq'
	
	rmy='rm RJG_'+line+'_L002_R2.fastq'
	rmz='rm RJG_'+line+'_L002_R2_new.fastq'
	...
	if not os.path.exists(line):
		os.makedirs(line)
		w='mv *'+line+'_L002_R1_all.fastq '+line+'/'
		os.system(w)
		w='mv *'+line+'_L002_R2_all.fastq '+line+'/'
		os.system(w)
	...
	os.chdir(line)
	w='/fh/fast/shou_w/bin/Robin/fastx/fastx_trimmer -f 5 -i RJG_'+line+'_L002_R1_all.fastq -o RJG_'+line+'_L002_R1_all.trimmed.fastq -Q 33'
	os.system(w)
	
	w= 'bwa aln -n 3 /fh/fast/shou_w/NextGenSeq/reference/RM11.fasta  RJG_'+line+'_L002_R1_all.trimmed.fastq > RJG_'+line+'_L002_R1_all.sai'
	os.system(w)
	
	#bwa samse ../../../reference/RM11.fasta $i.sai $i$R2 >$i.3mismatch.sam
	
	w='bwa samse /fh/fast/shou_w/NextGenSeq/reference/RM11.fasta RJG_'+line+'_L002_R1_all.sai RJG_'+line+'_L002_R1_all.trimmed.fastq > '+line+'.3mismatch.sam' 
	os.system(w)
	...
	w= 'bwa aln -n 3 /fh/fast/shou_w/NextGenSeq/reference/RM11.fasta  RJG_'+line+'_L002_R2_all.fastq > RJG_'+line+'_L002_R2_all.sai'
	os.system(w)
	
	#bwa samse ../../../reference/RM11.fasta $i.sai $i$R2 >$i.3mismatch.sam
	
	w='bwa samse /fh/fast/shou_w/NextGenSeq/reference/RM11.fasta RJG_'+line+'_L002_R2_all.sai RJG_'+line+'_L002_R2_all.fastq> '+line+'.1.3mismatch.sam' 
	os.system(w)
