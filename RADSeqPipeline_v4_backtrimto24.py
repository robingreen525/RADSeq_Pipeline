...
for line in ll:
	...
	if not os.path.exists(line):
 	...
 	os.chdir(line)
 	w='/fh/fast/shou_w/bin/Robin/fastx/fastx_trimmer -f 5 -i RJG_'+line+'_R1.fastq -o RJG_'+line+'_R1.trimmed.temp.fastq -Q 33'
 	os.system(w)
	
	################
	#trim read to 24 bp
	
	w='/fh/fast/shou_w/bin/Robin/fastx/fastx_trimmer -f 1 -l 24 -i RJG_'+line+'_R1.trimmed.temp.fastq -o RJG_'+line+'_R1.trimmed.fastq -Q 33'
 	os.system(w)
